const barMenuBtn: HTMLElement | null  = document.getElementById('bar__menuBtn');
const barMenu: HTMLElement | null = document.getElementById('bar__menu');
...
barMenuBtn.onclick = function(): void{
